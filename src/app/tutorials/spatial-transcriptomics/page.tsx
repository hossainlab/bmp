  ...
  return (
    <article className="prose prose-slate max-w-none pb-24 font-dm-sans">
      ...
      <section id="introduction" className="scroll-mt-32 mb-16">
        <h2 className="text-3xl font-bold text-slate-50 mb-6 pb-2 border-b border-slate-700">1. Intro to Spatial Omics</h2>
      ...
      <section id="technologies" className="scroll-mt-32 mb-16">
        <h2 className="text-3xl font-bold text-slate-50 mb-6 pb-2 border-b border-slate-700">2. Key Technologies</h2>
        <p className="text-lg text-slate-300 leading-relaxed mb-6">
      ...
      <section id="quality-control" className="scroll-mt-32 mb-16">
        <h2 className="text-3xl font-bold text-slate-50 mb-6 pb-2 border-b border-slate-700">3. Quality Control</h2>
        <p className="text-lg text-slate-300 leading-relaxed mb-6">
      ...
      <section id="spatial-domains" className="scroll-mt-32 mb-16">
        <h2 className="text-3xl font-bold text-slate-50 mb-6 pb-2 border-b border-slate-700">4. Spatial Domains</h2>
        <p className="text-lg text-slate-300 leading-relaxed mb-6">
      ...
      <section id="deconvolution" className="scroll-mt-32 mb-16">
        <h2 className="text-3xl font-bold text-slate-50 mb-6 pb-2 border-b border-slate-700">5. Cell Type Deconvolution</h2>
        <p className="text-lg text-slate-300 leading-relaxed mb-6">
      ...
      <section id="neighborhood" className="scroll-mt-32 mb-16">
        <h2 className="text-3xl font-bold text-slate-50 mb-6 pb-2 border-b border-slate-700">6. Neighborhood Analysis</h2>
        <p className="text-lg text-slate-300 leading-relaxed mb-6">
        ...
        <div className="grid sm:grid-cols-2 gap-6 my-8">
          <div className="bg-slate-950 border border-slate-700 rounded-xl p-6 shadow-sm">
            <h3 className="text-xl font-bold text-slate-50 mb-2">Co-localization</h3>
            <p className="text-slate-400 text-sm">Identifying pairs of cell types that frequently reside close to each other (e.g., T-cells and dendritic cells) using spatial statistics like Ripley&apos;s K-function.</p>
          </div>
          <div className="bg-slate-950 border border-slate-700 rounded-xl p-6 shadow-sm">
            <h3 className="text-xl font-bold text-slate-50 mb-2">Cell-Cell Communication</h3>
            <p className="text-slate-400 text-sm">Validating inferred receptor-ligand interactions by ensuring the sending and receiving cells are actually physically adjacent in the tissue.</p>
          </div>
        </div>
      </section>

      <section id="next-steps" className="scroll-mt-32">
        <div className="bg-gradient-to-br from-purple-900 to-indigo-900 text-white p-10 rounded-2xl shadow-xl relative overflow-hidden">
          ...
          <p className="text-lg text-purple-100 leading-relaxed mb-8 relative z-10 max-w-2xl">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row gap-4">
            <a 
              ...
              className="inline-flex items-center justify-center px-8 py-3.5 border border-transparent text-base font-bold rounded-lg text-purple-900 bg-slate-950 hover:bg-purple-50 transition-colors shadow-sm"
            >
              Apply Now
            </a>
          </div>
